  ...
  if(count($row_nav_sect_A)>0)
  {
    ...
    <table width=\"100%\"  style=\"border: 1px solid #000000;\"> 
        <tr>
            ...
            <td align=\"right\" width=\"200\"><b>" . (count($row_nav_sect_B)>0?number_format($row_nav_sect_B[0]['VAL'],$koma_nav,'.',','):"") . "</b></td>
        </tr>
        <tr>
            <td><b>Total Unit Issued</b></td>
            <td align=\"right\" width=\"200\"><b>" . (count($row_nav_sect_B)>2?number_format($row_nav_sect_H[0]['U'],$koma_unit,'.',','):"") . "</b></td>
        </tr>
        <tr>
            <td><b>NAV / Unit</b></td>
            <td align=\"right\" width=\"200\"><b>" . (count($row_nav_sect_B)>1?number_format($row_nav_sect_B[0]['VAL']/$row_nav_sect_H[0]['U'],$koma_price,'.',','):"") ."</b></td>
        </tr>
    </table><br />  ";
  }
$htmlnav4 ="
        ...
        <tr bgcolor=\"#ffffff\" valign=\"top\">
            <td width=\"30%\">
                <table width=\"100%\">
                    ...
                    $htmlnav4.="<tr>
                        <td align=\"left\" class=\"down_line\">{$xitem['ASSETTYPE']}</td>
                        <td align=\"center\" class=\"down_line\">-</td>
                        <td align=\"right\" class=\"down_line\">" . number_format($xitem['ACTPCT'],2,'.',',') . "</td>
                        <td align=\"center\" class=\"down_line\">-</td>
                    </tr>";
                    }}
                $htmlnav4.="</table>
            ...
            <td>
                <table width=\"100%\">
                    ...
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['CHANGEPERDAYVALUE'],4,'.',',') . "</td>
                    </tr>
                    <!--
                    <tr>
                    ...
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['CHANGEPERDAYPCT'],4,'.',',') . "</td>
                    </tr>
                    <tr bgcolor=\"#E0E0E0\">
            ...
            <td width=\"30%\">
                <table width=\"100%\">
                    ...
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['PREVMONTHPRICE'],$koma_price,'.',',') . "</td>
                    </tr>
                    <tr bgcolor=\"#E0E0E0\">
                        <th align=\"center\">Return(30 days)</th>
                    </tr>
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['RETURN30DAYS'],4,'.',',') . "%</td>
                    </tr>
                    <tr bgcolor=\"#E0E0E0\">
                        <th align=\"center\">Last NAV per Unit (" . date_format($row_nav_sect_D[0]['PREVYEARDATE'],'M d, Y') . ")</th>
                    </tr>
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['PREVYEARPRICE'],$koma_price,'.',',') . "</td>
                    </tr>
                    <tr bgcolor=\"#E0E0E0\">
                        <th align=\"center\">Return 1 Year</th>
                    </tr>
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['RETURN1YEAR'],4,'.',',') . "%</td>
                    </tr>
                    <tr bgcolor=\"#E0E0E0\">
                        <th align=\"center\">Return 1 Year Actual (%)</th>
                    </tr>
                    <tr>
                        <td align=\"center\" class=\"down_line\">&nbsp;" . number_format($row_nav_sect_D[0]['RETURN1YEARACT'],4,'.',',') . "</td>
                    </tr>
                </table>
            </td>
        </tr>
