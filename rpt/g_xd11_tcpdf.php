...
$htmlxd111 = "
    <table width=\"100%\"> 
        <tr>
            <td width=\"35%\"><b>{$row_pf["portfolioname"]}</b></td>
            <td width=\"30%\" align=\"center\"><b>LAPORAN AKTIVA DAN KEWAJIBAN REKSA DANA</b><br />{$date}</td>
            <td align=\"right\" width=\"35%\"><b>{$row_pf["fundmanagername"]}</b></td>
        </tr>
    </table><hr /> ";
$xd1_3 = isset($row_xd11[3])?number_format($row_xd11[3],4,'.',','):'&nbsp;';
$xd1_4 = isset($row_xd11[4])?number_format($row_xd11[4],4,'.',','):'&nbsp;';
$xd1_5 = isset($row_xd11[5])?number_format($row_xd11[5],4,'.',','):'&nbsp;';
$xd1_6 = isset($row_xd11[6])?number_format($row_xd11[6],4,'.',','):'&nbsp;';
$xd1_7 = isset($row_xd11[7])?number_format($row_xd11[7],4,'.',','):'&nbsp;';
$xd1_8 = isset($row_xd11[8])?number_format($row_xd11[8],4,'.',','):'&nbsp;';
$xd1_9 = isset($row_xd11[9])?number_format($row_xd11[9],4,'.',','):'&nbsp;';
$xd1_10 = isset($row_xd11[10])?number_format($row_xd11[10],4,'.',','):'&nbsp;';
$xd1_11 = isset($row_xd11[11])?number_format($row_xd11[11],4,'.',','):'&nbsp;';
$xd1_12 = isset($row_xd11[12])?number_format($row_xd11[12],4,'.',','):'&nbsp;';
$xd1_13 = isset($row_xd11[13])?number_format($row_xd11[13],4,'.',','):'&nbsp;';
$xd1_14 = isset($row_xd11[14])?number_format($row_xd11[14],4,'.',','):'&nbsp;';
$xd1_15 = isset($row_xd11[15])?number_format($row_xd11[15],4,'.',','):'&nbsp;';
$xd1_16 = isset($row_xd11[16])?number_format($row_xd11[16],4,'.',','):'&nbsp;';
$xd1_17 = isset($row_xd11[17])?number_format($row_xd11[17],4,'.',','):'&nbsp;';
$xd1_18 = isset($row_xd11[18])?number_format($row_xd11[18],4,'.',','):'&nbsp;';
$xd1_19 = isset($row_xd11[19])?number_format($row_xd11[19],4,'.',','):'&nbsp;';
$xd1_20 = isset($row_xd11[20])?number_format($row_xd11[20],4,'.',','):'&nbsp;';
$xd1_21 = isset($row_xd11[21])?number_format($row_xd11[21],4,'.',','):'&nbsp;';
$xd1_22 = isset($row_xd11[22])?number_format($row_xd11[22],4,'.',','):'&nbsp;';
$xd1_23 = isset($row_xd11[23])?number_format($row_xd11[23],4,'.',','):'&nbsp;';
$xd1_24 = isset($row_xd11[24])?number_format($row_xd11[24],4,'.',','):'&nbsp;';
$xd1_25 = isset($row_xd11[25])?number_format($row_xd11[25],4,'.',','):'&nbsp;';
$xd1_26 = isset($row_xd11[26])?number_format($row_xd11[26],4,'.',','):'&nbsp;';
$xd1_27 = isset($row_xd11[27])?number_format($row_xd11[27],4,'.',','):'&nbsp;';
$htmlxd1111 = "
