        ...
        <div style="padding: 3px;"> 
            ...
            <table bgcolor="#969696">            
                ...
                <tr bgcolor="#FFFFFF">
                    <td><span id="na_s_last_dt" style="font-weight: bold;"></span></td>
                    <td><span id="na_s_last_gl_dt" style="font-weight: bold;"></span></td>
                    <td><span id="na_s_ns" style="font-weight: bold;"></span></td>
                    <td><span id="na_s_gs" style="font-weight: bold;"></span></td>
            ...
            <table width="100%" bgcolor="#585858">
                ...
                <tr id="na_tr_nav_prev">
                    <th colspan="3" align="center" style="font-size: 150%; font-weight: bold;"><span id="s_nav_prev"></span></th>                    
                </tr>
            ...
            <div align="center">
                ...
                <button id="na_b_unapprove" disabled="disabled" style="display: none;">Un-Approve</button>      -
                <button id="na_b_gl_done" disabled="disabled">Gl Done</button>
                <button id="na_b_gl_undone" disabled="disabled" style="display: none;">GL Un-Done</button>
            </div>            
        </div>
        <div style="margin-top: 2px; margin: 2px; border: #800080 solid 1px;" id="na_d_view"></div>
        <div style="margin: 4px 2px 2px 2px; border: #800080 solid 1px;" id="na_d_viewtax" align="center"></div>
        <div style="margin-top: 2px; margin: 2px; border: #800080 solid 1px;" id="na_d_viewval"></div>
