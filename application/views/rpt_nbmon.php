...
<table width="100%" bgcolor="#808080">
    ...
    <tr bgcolor="#E0E0E0">
        <th align="center" width="40">APPROVED</th>
        <th width="50" align="left">BY</th>
        <th align="center" width="40">DONE</th>
        <th width="50" align="left">BY</th>
    </tr>
<?php $irow=0; $t='';  foreach ($r_data as $xitem1) { if($irow%2==0) $bg="#FFC0FF"; else $bg="#FF90FF"; ?>
    ...
    <tr bgcolor="<?php echo $irow%2==0?"#FFFFFF":"#F8F8F8";?>">
        ...
        <td align="center"><?php echo $xitem1['gl_status']=='A'?(is_object($xitem1['dodonedate'])?date_format($xitem1['dodonedate'],'m/d/Y-H:i'):''):''; ?></td>
        <td align="center"><?php echo $xitem1['ursstat']==0?"":(is_object($xitem1['doursdate'])?date_format($xitem1['doursdate'],'m/d/Y-H:i'):''); ?></td>        
    </tr>
