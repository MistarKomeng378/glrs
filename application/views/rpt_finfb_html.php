...
<div style="width: 965px;">
    ...
    <?php $gtfv=0;$gtcv=0;$gtmv=0;$gtai=0;$gtpl=0;  $gtprocen=0; $gtprocen=0; if(count($r_pvrfi)>0){ ?>
    ...
    <table cellspacing="1"  width="100%" >
        ...
        <?php $substr=""; $pvr_row=0;
                ...
                foreach($r_pvrfi as $xitem) {  $pvr_row++;
                    if($substr!=$xitem['jns'])
                    {
                        if($substr!='')
                        {
    ...
    <table width="100%">                                         
     ...
     <table cellspacing="1"  width="100%">
        ...
        <?php $substr="";
            ...
            foreach($r_pvros as $xitem) {        $osdec=trim($xitem['GLGroup'])=='100'?4:0;
            if($substr!=$xitem['jns'])
            {
                if($substr!='')
                {
        ...
        <tr>
            ...
            <td align="right"><?php echo  number_format($xitem['TotalValue']/$xitem['Holding'],4,'.',',') ;?></td>
    ...
    <table cellspacing="1"  width="100%">
        ...
        <tr>
            ...
            <td align="right" width="50"><?php echo number_format($xitem['TotalValue']/$xitem['Holding'],0,'.',',') ;?></td>
    ...
    <?php $gtcv+=$tcv;
    $gtmv+=$tmv;}?>
    <?php if(count($r_pvrfi)>0 || count($r_pvros)>0 || count($r_pvrri)>0 || count($r_pvrzl)>0){ ?>
    <br /><br />
    <table cellspacing="1"  width="100%">
        <tr>
            <td width="135">&nbsp;</td>
...
<!-- for BAS -->
    ...
    <table width="100%" >
        <tr >
            ...
            <td width="8">:</td>
            <td width="545"  align="left"><?php echo $r_pf[0]["pfname"];?></td>
        </tr>
        <tr>
            <td>Bank</td>
            <td width="8">:</td>
...
<!--for BAL-->
    ...
    <table width="100%">
        <tr >
            ...
            <td style="border-bottom: 1px dotted #969696;" align="right" width="100"><b>BALANCE in <?php echo $r_pf[0]["cur"];?></b></td>
        </tr>
        <?php $t_bal=0;$t_balidr=0;$bankcode="";   $bankname='';
    $gt_bal=0;$gt_balidr=0;
    foreach($r_bal     as $xitem) { 
