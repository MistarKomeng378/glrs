...
<div style="padding: 3px;background-color: #E0E0E0; border-bottom: 1px solid #ACACAC;">
            ...
            <div class="tb_title">MM Fund Type</div>
        </div>
        <div style="padding: 3px;">              
            <div  style="border: 1px solid #ACACAC; background-color: #F0F0F0;">               
                <input type="button" id="tp_b_new" value="New MM Fund Type "/>
                <input type="button" id="tp_b_edit" value="Update MM Fund Type "/>
               <!--
...
<div id="tp_dlg" style=" overflow:hidden; display:    none;padding:   0px;padding-top: 4px;"> 
    <table>
        ...
        <tr>            
            <td valign="top">MM Fund Id</td>
            <td valign="top">:</td>
            <td><input type="text" id="tp_i_tp_code_dlg"  style="width: 200px;" /></td>
            
        </tr>
        <tr>
            <td valign="top">MM Fund Name </td>
            <td valign="top">:</td>
            <td><textarea type="text" id="tp_i_tp_name_dlg"  style="width: 200px;" rows="1"></textarea></td>
        </tr>
    </table>
</div> 
<!-- END Add-->