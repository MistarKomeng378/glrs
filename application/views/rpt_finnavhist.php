 <hr />
    <table width="100%">                                         
        ...
        <tr>                                                                 
            <td colspan="2">NET ASSET VALUE REPORT</td>
        </tr>
        <tr>                                                                 
        ...
        <tr bgcolor="#ffffff" valign="top">
            ...
            <td>
                <table width="100%">
                    ...
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['CHANGEPERDAYVALUE'],4,'.',','); ?></td>
                    </tr>
                    <!--
                    <tr>
                    ...
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['CHANGEPERDAYPCT'],4,'.',','); ?></td>
                    </tr>
                    <tr bgcolor="#E0E0E0">
            ...
            <td width="30%">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['PREVMONTHPRICE'],$koma_price,'.',','); ?></td>
                    </tr>
                    <tr bgcolor="#E0E0E0">
                        <th align="center">Return(30 days)</th>
                    </tr>
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['RETURN30DAYS'],4,'.',','); ?>%</td>
                    </tr>
                    <tr bgcolor="#E0E0E0">
                        <th align="center">Last NAV per Unit (<?php echo is_object($sect_D[0]['PREVYEARDATE'])?date_format($sect_D[0]['PREVYEARDATE'],'M d, Y'):''; ?>)</th>
                    </tr>
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['PREVYEARPRICE'],$koma_price,'.',','); ?></td>
                    </tr>
                    <tr bgcolor="#E0E0E0">
                        <th align="center">Return 1 Year</th>
                    </tr>
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['RETURN1YEAR'],4,'.',','); ?>%</td>
                    </tr>
                    <tr bgcolor="#E0E0E0">
                        <th align="center">Return 1 Year Actual (%)</th>
                    </tr>
                    <tr>
                        <td align="center">&nbsp;<?php echo number_format($sect_D[0]['RETURN1YEARACT'],4,'.',','); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
