...
class Cxd1 extends CI_Controller {      
    var $data;
    ...
    function preview ()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $this->dompdf->render();
                $this->dompdf->stream("XD1{$param['no']}_{$this->data["r_pf"][0]['pfcode']}_" .  date_format(date_create($this->data["dt"]),'Ymd') . ".pdf");
            }
        }
        /*$html = $this->output->get_output();
